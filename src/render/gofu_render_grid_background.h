...
void gofu_render_grid_background_overlap (cairo_t *, gofu_t *, guint8,
					  guint8);
void gofu_render_grid_background_color_overlap (cairo_t *, gofu_t *, guint8,
						guint8);
void gofu_render_grid_background_image_overlap (cairo_t *, gofu_t *, guint8,
						guint8);
